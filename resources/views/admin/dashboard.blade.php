            ...
            <div class="col-12 col-lg-9">
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $pendingBookings }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Booking Dikonfirmasi</h6>
                                        <h6 class="font-extrabold mb-0">{{ $confirmedBookings }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Grafik Booking (12 Bulan Terakhir)</h4>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body py-4 px-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 name">
                                <h5 class="font-bold">Total Pendapatan</h5>
                                <h6 class="text-muted mb-0">Rp {{ number_format($totalRevenue, 2, ',', '.') }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
